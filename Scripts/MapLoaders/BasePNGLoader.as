...
// "every item" courtesy of Jackitch - updated 28/10/13
/*Changelog
28/10/13
	[added] heart
	[added] rotated platforms (now includes up, down, left, and right)
	[added] vertical doors (wood and stone) for red, blue, and neutral teams
	[added] flag spawns for the 6 remaining teams
*/
...
const SColor color_green_spawn(0xff649b0d);
const SColor color_purple_spawn(0xff9e3acc);  // WHY THE SAME AS NECROMANCER! FIXED
const SColor color_orange_spawn(0xff844715);
const SColor color_aqua_spawn(0xff4f9b7f);
const SColor color_teal_spawn(0xff4149f0);
const SColor color_gray_spawn(0xff97a792);
...
const SColor color_chicken(0xff8d2614);
//ostia et pedicas
const SColor color_ladder(0xff42240B);
const SColor color_platform_up(0xffff9239);
const SColor color_platform_right(0xffff9238);
const SColor color_platform_down(0xffff9237);
const SColor color_platform_left(0xffff9236);
const SColor color_wooden_door_h_blue(0xff1a4e83);
const SColor color_wooden_door_v_blue(0xff1a4e82);
const SColor color_wooden_door_h_red(0xff941b1b);
const SColor color_wooden_door_v_red(0xff941b1a);
const SColor color_wooden_door_h_noteam(0xff949494);
const SColor color_wooden_door_v_noteam(0xff949493);
const SColor color_stone_door_h_blue(0xff505aa0);
const SColor color_stone_door_v_blue(0xff505a9f);
const SColor color_stone_door_h_red(0xffa05a50);
const SColor color_stone_door_v_red(0xffa05a4f);
const SColor color_stone_door_h_noteam(0xffa0a0a0);
const SColor color_stone_door_v_noteam(0xffa0a09f);
...
const SColor color_heart(0xffff2850);
//vehiculis
...
class PNGLoader
{
	...
	if (pixel == color_tile_ground) {
		...
		{
			printf("SPAWN NECROMANCERRRRRRRRRRRRRRRRRRRRRRRRRRRRRR");
		...
		{
			spawnBlob( map, "mat_bombs", offset, -1);
			offsets[autotile_offset].push_back( offset );
		}
	...
	void SetupBackgrounds()
	{
		...
		//map.CreateSkyGradient( "Sprites/spacegradient.png" ); // override sky color with gradient
