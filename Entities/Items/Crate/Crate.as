...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	if (this.hasTag("unpackall"))
	{
		caller.CreateGenericButton( 12, Vec2f(0,-8), this, this.getCommandID("unpack"), "Unpack all" );
	}
	else if (hasSomethingPacked(this) && !canUnpackHere(this))
	{
		...
		CButton@ button = caller.CreateGenericButton( 12, Vec2f(0,-8), this, 0, msg );
		if (button !is null) {
    ...
    {
        caller.CreateGenericButton( "$DISABLED$", Vec2f(0,-8), this, this.getCommandID("stop unpack"), "Stop " + this.get_string("packed name") );
    }
    else if (hasSomethingPacked(this))
    {
		caller.CreateGenericButton( 12, Vec2f(0,-8), this, this.getCommandID("unpack"), "Unpack " + this.get_string("packed name") );
    }
...
void Unpack( CBlob@ this )
{
    ...
    CBlob@ blob = server_CreateBlob( this.get_string("packed"), teamNum, this.getPosition() + Vec2f(0.0f, -this.getRadius()) );
