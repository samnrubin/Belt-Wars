...
{
	//Don't let ship explosions kill their owner
	if(this.hasTag("spaceship")){
		return false;
	}
	//easy check
			  ...
			  const bool bother_raycasting = true, const bool should_teamkill = false )
{
	...
	// HACK cuz this shit aint workin otherwise
	if(this.hasTag("spaceship") && hit_blob.getDamageOwnerPlayer() is this.getDamageOwnerPlayer()){
		return false;
	}
