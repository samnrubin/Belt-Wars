	...
	{			
		...
		{						 
				...
				)
			{
				...
				{
					GUI::DrawText( mouseBlob.getInventoryName(), mouseBlob.getScreenPos() + Vec2f(-mouseBlob.getWidth(), mouseBlob.getHeight() + 16.0f), color_white );
