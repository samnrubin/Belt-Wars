...
const string grav_id = "toggle_gravity";
...
bool getGravOn(CBlob@ this)
{
	return this.hasTag("gravityGeneratorVertical");
}
...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	if(caller.getCarriedBlob() !is null && caller.getCarriedBlob().getNetworkID() == this.getNetworkID()){
...
void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	if(cmd == this.getCommandID(sawteammate_id))
	{
		...
		this.Untag("gravityGeneratorVertical");
	}
	...
	if(cmd == this.getCommandID(grav_id)){

		if(getGravOn(this)){
			this.Untag("gravityGeneratorVertical");
		}else{
			this.Tag("gravityGeneratorVertical");
			print("tagging gravity");
		}
