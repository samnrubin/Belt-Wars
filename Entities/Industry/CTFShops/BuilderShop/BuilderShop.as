...
void onInit(CBlob@ this)
{
...

	{
		...
		AddRequirement(s.requirements, "blob", "mat_wood", "Aluminum", COST_WOOD_LANTERN);
	}
	/*{
	...
	}*/
	{
		...
		AddRequirement(s.requirements, "blob", "mat_stone", "Iron", 35);
	}
	{
		ShopItem@ s = addShopItem(this, "Trampoline", "$trampoline$", "trampoline", descriptions[30], false);
		AddRequirement(s.requirements, "blob", "mat_wood", "Aluminum", COST_WOOD_TRAMPOLINE);
	}
	{
		ShopItem@ s = addShopItem(this, "Saw", "$saw$", "saw", descriptions[12], false);
		AddRequirement(s.requirements, "blob", "mat_wood", "Aluminum", COST_WOOD_SAW);
		AddRequirement(s.requirements, "blob", "mat_stone", "Iron", 100);
	}
	{
		ShopItem@ s = addShopItem(this, "Drill", "$drill$", "drill", descriptions[43], false);
		AddRequirement(s.requirements, "blob", "mat_stone", "Iron", COST_STONE_DRILL);
	}
